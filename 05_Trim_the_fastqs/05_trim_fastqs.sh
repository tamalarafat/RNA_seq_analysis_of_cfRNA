...
# Path to the directory where you want to store the Trim Galore reports
REPORT_DIR="/netscratch/dep_tsiantis/grp_laurent/tamal/2023/QC_Library/trim_galore_report"
